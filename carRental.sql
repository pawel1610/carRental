...
INSERT INTO rents values(0,3,2,'2019-01-31','2019-03-15','2019-03-17');
...
select zamowienia.data_zamowienia, imie, nazwisko, opis, ilosc, ilosc*cena as wartoscPLN, status  from zamowienia,klienci,produkty where zamowienia.idklienta = klienci.idklienta and zamowienia.idproduktu = produkty.idproduktu
